...
onetype.Assets('transforms', import.meta.url, { js: { path: '../addons/render/transforms', exclude: ['../addons/render/transforms/items/self'] } });
onetype.Assets('transforms/items', import.meta.url, { js: '../addons/render/transforms/items/self' });
onetype.Assets('pages', import.meta.url, { js: '../addons/render/pages', css: '../addons/render/pages/front' });
onetype.Assets('elements', import.meta.url, { js: { path: '../addons/render/elements/front', exclude: ['../addons/render/elements/front/items/self'] }, css: '../addons/render/elements/front' });
