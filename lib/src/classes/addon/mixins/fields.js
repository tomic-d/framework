const AddonFields =
{
    ...
    FieldAdd(name, define = null, get = null, set = null, map = false, callback = true)
    {
        ...
        if(callback)
        {
            this.fields.callbacks.add.forEach(handler => handler.call(this, this.fields.data[name]));
    ...
    FieldRemove(name, callback = true)
    {
        ...
        if(callback)
        {
            this.fields.callbacks.remove.forEach(handler => handler.call(this, this.fields.data[name]));
    ...
    FieldOn(type, callback)
    {
        ...
        {
            this.onetype.Error(400, 'Field catcher :type: not found.', {type});
            return this;
        }
