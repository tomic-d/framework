...
const AddonItems =
{
    ...
    ItemAdd(object, then = null, callback = true, set = true)
    {
        ...
        if(callback)
        {
            ...
            this.onetype.Emit('addon.item.add', this, item);
        }
        ...
        if(callback)
        {
            ...
            this.onetype.Emit('addon.item.added', this, item);
        }
    ...
    ItemRemove(id, callback = true)
    {
        ...
        if(callback)
        {
            ...
            this.onetype.Emit('addon.item.remove', this, item);
        }
        ...
        if(callback)
        {
            ...
            this.onetype.Emit('addon.item.removed', this, item);
        }
    },
