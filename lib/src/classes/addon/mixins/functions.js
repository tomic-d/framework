const AddonFunctions =
{
    FnAdd(name, callback)
    {
        ...
        {
            this.onetype.LogWarn('Function "' + name + '" callback is not a function.');
            return this;
        }
        ...
        {
            this.onetype.LogError('Error in function "' + name + '" callback add.', {}, error);
        }
    ...
    FnRun(name, ...data)
    {
        ...
        if (!fn)
        {
            this.onetype.LogError('Function not found.', {name});
            return null;
        }
        ...
        {
            this.onetype.LogError('Error in function callback before.', {name}, error);
        }
        ...
        {
            this.onetype.LogError('Error in function callback after.', {name}, error);
        }
    ...
    FnRemove(name)
    {
        ...
        {
            this.onetype.LogError('Error in function callback remove.', {name: fn.name}, error);
        }
